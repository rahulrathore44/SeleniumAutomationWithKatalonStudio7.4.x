...
def static "com.question.mongo.connectRobo3t.connection"(
    	String url	) {
    (new com.question.mongo.connectRobo3t()).connection(
        	url)
}
...
def static "com.helper.sftp.SftpKeyword.sftpDownloadUpload"(
    	String localFile	
     , 	String remoteDir	
     , 	String remoteFile	
     , 	String updateContent	) {
    (new com.helper.sftp.SftpKeyword()).sftpDownloadUpload(
        	localFile
         , 	remoteDir
         , 	remoteFile
         , 	updateContent)
